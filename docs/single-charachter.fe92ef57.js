...
},{}],"zK0B":[function(require,module,exports) {
...
var tplSingle = document.querySelector("#tpl-single");
var trgSingle = document.querySelector("#single-target");
var characterId = localStorage["stored"]; //Import Character from the main page

var loadCharacters = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var response, character, charImport;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            charImport = document.importNode(tplSingle.content, true);
...
loadCharacters(); //Delete Character

document.getElementById("delete").addEventListener("click", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  var action, result;
  return regeneratorRuntime.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          console.log("hello");
          action = confirm("are you sure you want to delete this character");
        ...
        case 6:
          _context2.next = 8;
          return fetch("https://character-database.becode.xyz/characters/".concat(characterId), {
            method: "DELETE"
          });
...
var imageDisplay = document.getElementById("single-image");
var nameDisplay = document.getElementById("name");
var shortDiscription = document.getElementById("short");
var detailedDiscription = document.getElementById("detailed");
var nextBtn = document.getElementById("next");
var base64Header = "data:image/jpeg;base64";
var id;
var counter = 0;

var renderCharacter = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var characters, currentCharacter, fetchedSrc, base64;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            counter++;
            currentCharacter = characters[counter];
            console.log(currentCharacter);
            fetchedSrc = currentCharacter.image;
            base64 = "".concat(base64Header, ",").concat(fetchedSrc);
...
},{"regenerator-runtime/runtime":"QVnC"}]},{},["zK0B"], null)
//# sourceMappingURL=single-charachter.fe92ef57.js.map