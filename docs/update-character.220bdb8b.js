...
},{}],"fg5x":[function(require,module,exports) {
...
var recievedName = document.getElementById("new-name");
var recievedShortDescription = document.getElementById("shortDescription");
var recievedDescription = document.getElementById("markdown");
var formContainer = document.getElementById("form-container");
var closeBtn = document.getElementById("close");
var cancelBtn = document.getElementById("x-short");
var imageUpload = document.getElementById("user-image"); // i intentionally have added two different close buttons on

var currentBase64;
var base64Split;

var imageToBase64 = function imageToBase64(element) {
...
var beCodeUrl = "https://character-database.becode.xyz/characters";
var targetId = localStorage["stored"];

var saveCharacter = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var response, targetCharacter;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("".concat(beCodeUrl, "/").concat(targetId));
          ...
          case 5:
            ...
            if (recievedShortDescription.value === null || recievedShortDescription.value === "") {
            ...
            fetch("".concat(beCodeUrl, "/").concat(targetId), {
              method: "put",
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            targetCharacter = _context2.sent;
...
var updateCharacterBtn = document.querySelector(".update");
var saveChangesBtn = document.getElementById("submit");
saveChangesBtn.addEventListener("click", saveCharacter);
updateCharacterBtn.addEventListener("click", editMode); // const formContainer=document.getElementById('form-container');
...
},{"regenerator-runtime/runtime":"QVnC"}]},{},["fg5x"], null)
//# sourceMappingURL=update-character.220bdb8b.js.map